...
@pytest.fixture
def commen_user():
    user = User.objects.create_user(email="admin@gmail.com", password="jcjdjr2132@", is_verified=True)
    return user
...
class TestPostApi:
    ...
    def test_create_post_invalid_data_response_400_status(self, api_client, commen_user):
        url = reverse("blog:api-v1:post-list")
        data = {
            "title": "test",
            "content": "description",
